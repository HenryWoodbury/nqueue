...
export function Upload({ endpoint, fileType = ['text/csv'], successCallback }: Upload) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <FieldLabel htmlFor="csv-upload" className="block px-2 py-1 w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer focus:outline-none">
